		...
		{
			{
				...
				constexpr auto ret = enh::signumFunction(base);
			...
			{
				arithmetic base = 25;
				auto ret = enh::signumFunction(base);
		...
		{
			{
				...
				constexpr auto ret = enh::inclusiveRatio(numerator, denominator);
...

			{
				...
				auto ret = enh::inclusiveRatio(numerator, denominator);
		...
		{
			{
				...
				constexpr bool ni_ret = enh::isConfinedWithin(unchecked, lbound, ubound, false, false);
				ASSERT_CONTINUE(ni_ret, "constexpr bound check in middle, non-inclusive");

				constexpr bool ui_ret = enh::isConfinedWithin(unchecked, lbound, ubound, false, true);
				ASSERT_CONTINUE(ui_ret, "constexpr bound check in middle, upper inclusive");

				constexpr bool li_ret = enh::isConfinedWithin(unchecked, lbound, ubound, true, false);
				ASSERT_CONTINUE(li_ret, "constexpr bound check in middle, lower inclusive");

				constexpr bool i_ret = enh::isConfinedWithin(unchecked, lbound, ubound, true, true);
...

			{
				...
				type lbound = type(10);
				type ubound = type(50);
				bool ni_ret = enh::isConfinedWithin(unchecked, lbound, ubound, false, false);
				ASSERT_CONTINUE(ni_ret, "bound check in middle, non-inclusive");

				bool ui_ret = enh::isConfinedWithin(unchecked, lbound, ubound, false, true);
				ASSERT_CONTINUE(ui_ret, "bound check in middle, upper inclusive");

				bool li_ret = enh::isConfinedWithin(unchecked, lbound, ubound, true, false);
				ASSERT_CONTINUE(li_ret, "bound check in middle, lower inclusive");

				bool i_ret = enh::isConfinedWithin(unchecked, lbound, ubound, true, true);
