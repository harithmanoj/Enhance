...
enh::Tristate process(enh::GenericMessage<int, std::string, std::string> msg)
{
...
int main()
{
	enh::QueuedHandler<enh::GenericMessage<int, std::string, std::string>> prc(process);
	prc.startDispatcherExecution();
